...
class _PlaceholderCover extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Warm, medium-depth palette — not so dark that text disappears
    final baseColor = HSLColor.fromAHSL(1, hue, 0.30, 0.38).toColor();
    final darkColor = HSLColor.fromAHSL(1, hue, 0.40, 0.22).toColor();
